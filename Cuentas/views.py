...
def register (request): 
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            return render(request, "Indice/Plantillas/index.html", {'msj':f'Se creo el usuario {username}'})
        else:
...
def buscar_url_avatar(user):
    ...
    if usuario_extendido.imagen:
        ...
        return 'https://img1.freepng.es/20190518/kqt/kisspng-scalable-vector-graphics-portable-network-graphics-paddle-svg-png-icon-free-download-482934-onli-5ce0cdcdd82c94.0273046215582366218855.jpg' 
